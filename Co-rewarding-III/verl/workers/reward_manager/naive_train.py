...
@register("naive_train")
class NaiveTrainRewardManager(AbstractRewardManager):
    """The reward manager."""
    ...
    def __call__(self, data: DataProto, return_dict: bool = False) -> torch.Tensor | dict[str, Any]:
        ...
        for i in range(len(data)):
            ...
            # #################################
            pseudo_label = uid2policypseudo[data_item.non_tensor_batch["uid"]]
        ...
        pseudo_policy_acc = gt_policypseudo_correct / gt_total_pseudo if gt_total_pseudo != 0 else 0
        metrics = {
            "coreward/gt_empty": gt_empty,
            "coreward/pseudo_equal_gt": gt_policypseudo_correct,
