...
def load_reward_manager(
    config: DictConfig, tokenizer: Any, num_examine: int, reward_manager_name: str, **reward_kwargs: Any
...
def compute_aug_reward(data_ori: DataProto, data_aug: DataProto, reward_fn: AbstractRewardManager):
    """
    Compute reward for a batch of data.
    Args:
        data: DataProto object containing the input data.
    ...
    try:
        ...
        reward_tensor_ori = reward_result["reward_tensor_ori"]
        reward_tensor_aug = reward_result["reward_tensor_aug"]
        reward_extra_infos_dict = reward_result.get("reward_extra_info", {})
    except Exception as e:
        print(f"Error in reward_fn: {e}")
        reward_tensor_ori, reward_tensor_aug = reward_fn(data_ori, data_aug)
        reward_extra_infos_dict = {}
