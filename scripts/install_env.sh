...
pip install "transformers[hf_xet]>=4.51.0" accelerate datasets peft hf-transfer \
    ...
    "ray[default]==2.45.0" codetiming hydra-core pylatexenc qwen-vl-utils wandb dill pybind11 liger-kernel mathruler \
...
pip install "opentelemetry-api<1.27.0,>=1.26.0"
